...
class TestClass(unittest.TestCase):
   ...
   def test_one(self):
      ...
      # print(lookup_movie_score_tm("Vanhempainilta"))
       print(tmdb_search_movie("The Accountant 2"))
       print(returnMovieDetails("The Accountant 2",  "../Data/tomato.json"))
       ...
       print((cleaned_text))  # Output: "thisissampletextwithpunctuation"
...
if __name__ == '__main__':
    ...
    print(lookup_movie_score_tm("The Accountant 2"))
